...
namespace Vectores
{
    public partial class Form1 : Form
    {
        ...
        private void recuenciaDeDistribucion1ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            v1.FrecDist1(ref v2,ref v3,int.Parse(textBox1.Text));
        }
        ...
        {
            textBox4.Text = "" + v3.busBin(int.Parse(textBox1.Text));
        }
