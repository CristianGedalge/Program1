...
type
  TfrmPrincipal = class(TForm)
    ...
    procedure NumToLiteral1Click(Sender: TObject);
...
procedure TfrmPrincipal.NumToLiteral1Click(Sender: TObject);
begin
label1.caption:= N.NumToLiteral;
end;
